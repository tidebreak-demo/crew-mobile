...
import { ReassignmentPushNotification } from "../components/ReassignmentPushNotification"
...
describe("ReassignmentPushNotification", () => {
  beforeEach(() => baseProps.onSelect.mockClear())

  it("renders the job label and crew count", () => {
    render(<ReassignmentPushNotification {...baseProps} />)
  ...
  it("shows an unstaffed job without a crew count", () => {
    render(<ReassignmentPushNotification {...baseProps} crewCount={0} />)
