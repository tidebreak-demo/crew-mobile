...
import { ShiftHandoverDraft } from "../components/ShiftHandoverDraft"
...
describe("ShiftHandoverDraft", () => {
  ...
  it("shows an unstaffed job without a crew count", () => {
    render(<ShiftHandoverDraft {...baseProps} crewCount={0} />)
