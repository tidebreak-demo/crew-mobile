...
import { SignatureCaptureRetry } from "../components/SignatureCaptureRetry"
...
describe("SignatureCaptureRetry", () => {
  ...
  it("shows an unstaffed job without a crew count", () => {
    render(<SignatureCaptureRetry {...baseProps} crewCount={0} />)
