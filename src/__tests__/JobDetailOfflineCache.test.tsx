...
import { JobDetailOfflineCache } from "../components/JobDetailOfflineCache"
...
describe("JobDetailOfflineCache", () => {
  ...
  it("shows an unstaffed job without a crew count", () => {
    render(<JobDetailOfflineCache {...baseProps} crewCount={0} />)
