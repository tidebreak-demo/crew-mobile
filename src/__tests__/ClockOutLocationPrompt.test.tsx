...
import { ClockOutLocationPrompt } from "../components/ClockOutLocationPrompt"
...
describe("ClockOutLocationPrompt", () => {
  ...
  it("shows an unstaffed job without a crew count", () => {
    render(<ClockOutLocationPrompt {...baseProps} crewCount={0} />)
