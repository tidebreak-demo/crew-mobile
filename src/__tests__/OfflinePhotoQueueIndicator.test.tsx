...
import { OfflinePhotoQueueIndicator } from "../components/OfflinePhotoQueueIndicator"
...
describe("OfflinePhotoQueueIndicator", () => {
  beforeEach(() => baseProps.onSelect.mockClear())

  it("renders the job label and crew count", () => {
    render(<OfflinePhotoQueueIndicator {...baseProps} />)
  ...
  it("shows an unstaffed job without a crew count", () => {
    render(<OfflinePhotoQueueIndicator {...baseProps} crewCount={0} />)
