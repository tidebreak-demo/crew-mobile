...
import { UnsentChangesBadge } from "../components/UnsentChangesBadge"
...
describe("UnsentChangesBadge", () => {
  ...
  it("shows an unstaffed job without a crew count", () => {
    render(<UnsentChangesBadge {...baseProps} crewCount={0} />)
